...
namespace Microsoft { namespace Azure { namespace DeviceManagement { namespace Common {
    ...
    public:
        ...
        void RunGetStructData(const std::string& path, ELEMENT_HANDLER handler);
        ...
        void RunAddTyped(const std::string& path, const std::string& type);

        void RunAdd(const std::string& path, const std::string& value);
        ...
        void RunExecWithParameters(const std::string& path, const std::string& params);
