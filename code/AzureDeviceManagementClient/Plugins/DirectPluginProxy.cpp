...
namespace Microsoft { namespace Azure { namespace DeviceManagement { namespace Client {
    ...
    std::vector<DMCommon::HandlerInfo> DirectPluginProxy::GetHandlersInfo() const
    {
        ...
        {
            throw DMException(PLUGIN_ERR_MISSING_ENTRY_POINT, "Failed to find entry point GetHandlersInfo.");
        }
        ...
        const std::string& id)
    {
        ...
        {
            throw DMException(PLUGIN_ERR_MISSING_ENTRY_POINT, "Failed to find entry point PluginCreateRawHandler.");
        }
        ...
        const std::string& id)
    {
        ...
        {
            throw DMException(PLUGIN_ERR_MISSING_ENTRY_POINT, "Failed to find entry point PluginDestroyRawHandler.");
        }
