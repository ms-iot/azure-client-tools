...
- Download a pre-built version of the client: [x86](../../downloads/device.agent.2.0.0.3.x86.zip), [x64](../../downloads/device.agent.2.0.0.3.x64.zip), or [arm](../../downloads/device.agent.2.0.0.3.arm.zip).
